            ...
            {winningPosition && (
                <h2>
                    ...
                    {totalWinning > totallosses
                        ? `Congratulations you won $${totalWinning - totallosses
...
const App = () => {
    ...
    return (
        <div className="dice-game-container">
            {balance > 0 ? <><h1>Lets Play Some Dice!!</h1>
                ...
                <>
                    <h1>No amount left to place bets</h1>
                    <button className="dice-game-betting-button" onClick={() => setBalance(100)}> Add $100 more to balance</button>
                </>
